...
const teamMembers = [
  {
    ...
    role: 'Founder & CEO',
    description:
      'Visionario tech con una passione bruciante per l\'intelligenza artificiale e lo sviluppo software. Guida Demicorp con l\'obiettivo di ridefinire i confini della tecnologia, combinando innovazione, creatività e una visione audace del futuro. Full-stack developer, AI enthusiast e imprenditore digitale.',
    skills: ['Leadership', 'AI Strategy', 'Full-Stack Dev', 'Game Design', 'Business Vision'],
    color: '#8b5cf6',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <div className="overflow-hidden">
            <p className="team-title-line text-sm font-mono text-demicorp-violet uppercase tracking-[0.3em] mb-4">
              Il team
            </p>
          </div>
          <div className="overflow-hidden">
            <h2 className="team-title-line text-4xl md:text-6xl lg:text-7xl font-display font-bold">
              <span className="text-demicorp-white">Le Menti </span>
              <span className="gradient-text">Dietro Demicorp</span>
            </h2>
          </div>
          <div className="overflow-hidden mt-4">
            <p className="team-title-line text-lg text-demicorp-gray max-w-2xl mx-auto font-body">
              Talento, visione e determinazione al servizio dell&apos;innovazione
            </p>
          </div>
        </div>
              ...
              <div className="relative p-8 md:p-12 rounded-3xl glass-strong">
                <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="relative w-48 h-48 md:w-56 md:h-56">
                      ...
                      <motion.div
                        ...
                        style={{
                          background:
                            'conic-gradient(from 0deg, #8b5cf6, #06d6a0, #4361ee, #ff006e, #8b5cf6)',
                        }}
                        animate={{ rotate: 360 }}
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h3 className="text-3xl md:text-4xl font-display font-bold text-demicorp-white mb-1">
                      {member.name}
                    </h3>
                    <p className="text-lg font-mono text-demicorp-violet mb-4">{member.role}</p>
                    <p className="text-demicorp-gray font-body leading-relaxed mb-6 max-w-xl">
                      {member.description}
                    </p>
        ...
        >
          <div className="inline-block p-8 rounded-2xl glass">
            <h4 className="text-2xl font-display font-bold text-demicorp-white mb-2">
              Vuoi far parte del team?
            </h4>
            <p className="text-demicorp-gray font-body mb-6">
              Cerchiamo menti brillanti pronte a costruire il futuro con noi
            </p>
            <motion.a
              href="#contact"
