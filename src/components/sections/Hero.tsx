  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-7xl mx-auto">
        {/* Badge */}
        <motion.div
          className="hero-badge inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8"
          whileHover={{ scale: 1.05 }}
        >
          <span className="w-2 h-2 rounded-full bg-demicorp-cyan animate-pulse" />
          <span className="text-sm font-mono text-demicorp-gray tracking-wider uppercase">
            Shaping the Future
          </span>
        </motion.div>
        ...
        <p
          ref={subtitleRef}
          className="hero-subtitle text-lg md:text-xl text-demicorp-gray max-w-2xl mx-auto mb-12 leading-relaxed font-body"
        >
          Pionieri nell&apos;automazione AI, nello sviluppo di videogiochi 3D
          e nella creazione di software che ridefinisce il possibile.
        </p>
        ...
        <div className="hero-cta flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          >
            ...
            <span className="relative z-10 text-white">Scopri i Servizi</span>
          </motion.button>
      ...
      <div className="hero-scroll-indicator absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2">
        <span className="text-xs font-mono text-demicorp-gray/50 uppercase tracking-widest">
          Scroll
        </span>
        <motion.div
          className="w-6 h-10 rounded-full border-2 border-demicorp-gray/30 flex justify-center pt-2"
          animate={{ opacity: [0.3, 1, 0.3] }}
          transition={{ duration: 2, repeat: Infinity }}
        >
          <motion.div
            className="w-1 h-2 rounded-full bg-demicorp-violet"
            animate={{ y: [0, 12, 0] }}
            transition={{ duration: 2, repeat: Infinity }}
          />
        </motion.div>
